import { IApiJson, PureObject } from '@/shared'
...
type pureObjectWithResultCode<T> = IApiJson<T>
...
export const resultCodeChecker = <S>(rawData: pureObjectWithResultCode<S>) => {
  ...
  throw getErrorMessage(`Unhandled response result code: ${rawData.resultCode}`)
}
